...
export function ReferralsList({ referrals }) {
  ...
  return (
    <div className="bg-white rounded-3xl shadow-xl border border-slate-100 overflow-hidden mt-8 animation-fade-in-up">
              ...
              >
                <td className="px-8 py-5">
                  <div className="flex items-center gap-4">
                    <div className="w-10 h-10 rounded-full bg-linear-to-br from-[#0e2b4a] to-blue-600 flex items-center justify-center text-white font-bold text-sm shadow-md group-hover:scale-110 transition-transform">
                ...
                <td className="px-6 py-5">
                   ...
                   <span className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold border ${
                      ...
                      {user.status === "active" ? <ShieldCheck size={12}/> : <Clock size={12}/>}
